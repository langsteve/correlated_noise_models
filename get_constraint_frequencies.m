...
%   g_at_constraint_frequencies : (mx1) vector containing the values of g(Omega) at the constraint frequencies.
%
% NOTE: alpha_1 and alpha_2 must satisfy the inequalities:
%       |alpha_2| <= 1 and (1 - alpha_2) ^ 2 - alpha_1 ^ 2 >= 0
%
%-- Reference:
%      [1] S. Langel, O. Garcia Crespillo, and M. Joerger, "Robust modeling of correlated Gaussian noise in
%          Kalman filtering," IEEE Trans. Aerosp. Electron. Syst., vol. xx, no. xx, pp. xx-xx, May, 2023,
%          doi: xx.xxxx/TAES
